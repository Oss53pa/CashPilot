  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Calculer la probabilite que la position soit inferieure a un seuil
          donne
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="flex flex-wrap items-end gap-3">
          ...
          <Button onClick={handleCalculate} disabled={loading} size="sm">
        ...
        {result && (
          <div className="rounded-lg border bg-muted/30 px-4 py-4 space-y-2">
            <p className="text-sm">
              ...
              <strong>{formatFrancs(result.threshold)}</strong> le{" "}
              <strong>{result.date}</strong> est de :
            </p>
