...
export function CausalInterventions({
  interventions,
}: CausalInterventionsProps) {
  return (
          ...
          <CardContent className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              <Badge variant="outline">
                Variable: {iv.intervention_variable}
              </Badge>
            ...
            <div className="rounded-lg bg-muted/50 p-3">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-lg font-bold ${iv.estimated_effect >= 0 ? "text-green-600" : "text-red-600"}`}
                >
                  {formatFrancs(iv.estimated_effect, {
                    compact: true,
                    showSign: true,
                  })}
                </span>
              ...
              <div className="flex items-center justify-between mt-1">
                ...
                <span
                  className={`text-sm font-semibold ${confidenceColor(iv.confidence)}`}
                >
