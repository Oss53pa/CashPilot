...
const mockHistory: HistoryEntry[] = [
  {
    id: "1",
    label: "Baisse recouvrement a 70%",
    date: "18 mars 2026",
    netImpact: -28_500_000,
  },
  {
    id: "2",
    label: "CAPEX +30% renovation",
    date: "15 mars 2026",
    netImpact: -45_200_000,
  },
  {
    id: "3",
    label: "Revenus +15% nouveaux baux",
    date: "12 mars 2026",
    netImpact: 32_000_000,
  },
  {
    id: "4",
    label: "Delai paiement +30 jours",
    date: "10 mars 2026",
    netImpact: -18_000_000,
  },
];
...
export default function WhatIf() {
  ...
  const isModified =
    params.recoveryRate !== 85 ||
    params.paymentDelay !== 0 ||
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-6">
      <PageHeader
        ...
        description="Simulez l'impact de variations sur votre tresorerie previsionnelle"
      />
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Ajustez les curseurs pour voir l'impact en temps reel
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-2">
              {mockHistory.map((h) => (
                ...
                >
                  ...
                  <span
                    className={`text-sm font-bold ${h.netImpact >= 0 ? "text-green-600" : "text-red-600"}`}
                  >
                    {formatFrancs(h.netImpact, { showSign: true })}
                  </span>
                </div>
              ))}
            </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`text-xl font-bold ${isModified ? (impact.total >= 0 ? "text-green-600" : "text-red-600") : ""}`}
                  >
                    {isModified
                      ? formatFrancs(impact.total, { showSign: true })
                      : "0 FCFA"}
                  </span>
                </div>
              </CardContent>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-xl font-bold text-red-600">
                      {isModified
                        ? formatFrancs(impact.worst, { showSign: true })
                        : "-"}
                    </span>
                    {isModified && (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-xl font-bold text-green-600">
                      {isModified
                        ? formatFrancs(impact.best, { showSign: true })
                        : "-"}
                    </span>
                    {isModified && (
                      <span className="text-xs text-muted-foreground ml-2">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">
                Comparaison Base vs Scenario modifie
              </CardTitle>
              <CardDescription>
                {isModified
