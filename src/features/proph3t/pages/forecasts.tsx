...
function generateChartData(horizon: Horizon) {
  const days: Record<Horizon, number> = {
    "J+7": 7,
    "J+30": 30,
    "J+90": 90,
    "J+365": 365,
...
const mockAnomalies: MockAnomaly[] = [
  {
    id: "1",
    severity: "critical",
    description: "Ecart de +45% sur encaissements ECOBANK vs prevision J+7",
    date: "18 mars 2026",
    amount: 12_500_000,
  },
  {
    ...
    severity: "alert",
    description:
      "Decaissements fournisseurs superieurs de 28% a la moyenne mobile 12 semaines",
    date: "17 mars 2026",
    amount: 8_200_000,
  },
  {
    ...
    severity: "watch",
    description:
      "Regularite des loyers ZARA CI en baisse de 15% sur 4 semaines",
    date: "16 mars 2026",
    amount: 3_400_000,
  },
  {
    id: "4",
    severity: "watch",
    description: "Flux sortant inhabituel sur compte SGBCI CAPEX a 23h15",
    date: "15 mars 2026",
    amount: 25_000_000,
  },
  {
    ...
    severity: "normal",
    description:
      "Variation saisonniere detectee sur TVA collectee - conforme historique",
    date: "14 mars 2026",
    amount: 0,
  },
];
      ...
      <Tabs value={mainTab} onValueChange={setMainTab}>
            ...
            <TabsContent value={horizon} className="mt-4 space-y-6">
                    ...
                    <Card key={sc.key} className="relative overflow-hidden">
                      ...
                      <CardContent>
                        ...
                        <div className="flex items-center gap-1 mt-2 text-xs">
                          <TrendIcon
                            className={`h-3.5 w-3.5 ${sc.trend === "up" ? "text-green-600" : sc.trend === "down" ? "text-red-500" : "text-gray-500"}`}
                          />
                          <span
                            className={
                              sc.trend === "up"
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-base">
                    Prevision de tresorerie — {horizon}
                  </CardTitle>
                  <CardDescription>
                    Montants cumules par scenario (FCFA)
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={380}>
                    ...
                    >
                      ...
                      />
                      <Tooltip
                        formatter={(value: number) => formatFrancs(value)}
                      />
                      <Legend />
                      <Area
                        type="monotone"
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {mockAnomalies.length} anomalies detectees par le moteur IA
                  </CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <TabsContent value="incertitude" className="mt-4 space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">
                Prevision en eventail (Fan Chart)
              </CardTitle>
              <CardDescription>
                Prevision centrale avec intervalles credibles a 80% et 95% —
                l'eventail s'elargit avec l'horizon
              </CardDescription>
            </CardHeader>
            <CardContent>
